      ...
      <div class="row clearfix">
        <div class="col-md-4">
          <div class="hi-icon-wrap hi-icon-effect wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="300ms" > 
           <a href="<?php echo base_url();?>my_account"><i class="fa fa-book"></i></a>
            <h2><a href="<?php echo base_url();?>my_account">Aptitude Test</a></h2>
            <p>Know your aptitude to get a right career</p>
          </div>
        </div>
        <div class="col-md-4">
          <div class="hi-icon-wrap hi-icon-effect wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="600ms" > 
          <a href="<?php echo base_url();?>my_account"><i class="fa fa-laptop"></i></a>
            <h2><a href="<?php echo base_url();?>my_account">Personality Test</a></h2>
            <p>Your Career path depends on your personality</p>
          </div>
        </div>
        <div class="col-md-4">
          <div class="hi-icon-wrap hi-icon-effect wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="300ms" > 
            <a href="<?php echo base_url();?>my_account"><i class="fa fa-archive"></i></a>
            <h2><a href="<?php echo base_url();?>my_account">Counseling SESSION</a></h2>
