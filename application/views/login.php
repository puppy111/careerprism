    ...
    <div id="login-overlay" class="modal-dialog">
      <div class="modal-content">
          <div class="modal-header">
              <h4 class="modal-title" id="myModalLabel">Login to <b>careerprism.in</b></h4>
                      ...
                      <div class="well">
                          <?php echo form_open("login");?>
                              <div class="form-group">
                                  <label for="phone" class="control-label">Phone or Cp ID*</label>
                                  <input type="text" name="phone" class=" form-control" placeholder="Phone number or CP ID"
                            ...
                            value="<?php echo set_value('password'); ?>">
                              ...
                              <button type="submit" class="btn btn-success btn-block" name="loginSubmit">Student Login</button>
                          </form>
                      </div>
                  </div>
                  <div class="col-xs-12 col-sm-6 col-lg-6 col-md-6">
                      ...
                      <p><a href="register" class="btn btn-success btn-block">Student Registration </a></p>
                      
                      <p><a href="<?php echo base_url(); ?>counseller/login" class="btn btn-danger btn-block">Counseller Login</a></p>
                  </div>
              </div>
          </div>
      </div>
