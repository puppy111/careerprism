...
?>	
    ...
    <div class="row">
        <ol class="breadcrumb">
            ...
            <li class="active">Stream/<?php echo $bread_crum['0']['title']; ?></li>
        </ol>
    </div><!--/.row-->
		...
		<div class="row">
			<div class="col-md-12">
				<div class="panel panel-default">
					<div class="panel-heading">Under <?php echo $bread_crum['0']['title']; ?></div>
  ...
  <script type="text/javascript">
    ...
    $(document).ready(function() 
	{
	  ...
	  ({ 
       ...
       "serverSide": true, //Feature control DataTables' server-side processing mode.
        ...
        "ajax": {
            "url": "<?php echo site_url('admin/branch/ajax_list/'.$id)?>",
            "type": "POST"
        },
    ...
    function edit_person(id)
    {
      ...
      $.ajax({
        url : "<?php echo site_url('admin/branch/ajax_edit/')?>/"+id,
        type: "GET",
        dataType: "JSON",
    ...
    function save()
    {
      ...
      if(save_method == 'add') 
      {
          	url = "<?php echo site_url('admin/branch/ajax_add/'.$id)?>";
      }
      else
      {
        	url = "<?php echo site_url('admin/branch/ajax_update/'.$id)?>";
      }
    ...
    function delete_person(id)
    {
      if(confirm('Are you sure delete this data?'))
      {
        // ajax delete data to database
          $.ajax({
            url : "<?php echo site_url('admin/branch/ajax_delete')?>/"+id,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
		...
		{  
            ...
            if(check == true){  
                ...
                $.ajax({   
                    ...
                    type: "POST",  
                    url : "<?php echo site_url('admin/branch/ajax_multi_delete')?>/",
                    cache:false, 
					dataType: "JSON", 
        ...
        <form action="#" id="form" class="form-horizontal">
          ...
          <div class="form-body">
            <div class="form-group">
              ...
              <div class="col-md-9">
                <input name="title" placeholder="branch" class="form-control" type="text">
              </div>
            </div>
