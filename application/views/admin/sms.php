    ...
    <div class="col-md-12">
        <div class="panel panel-default">
            ...
            <form method='post'>
                ...
                <tr>
                    <td>Number</td>
                    <td><input type='text' name='phone_number' class='form-control' required placeholder="Number1,Number2"></td>
                </tr>
            
               <tr>
                    <td>Message</td>
                    <td><textarea name='sms_message' class='form-control' cols="5" rows="5" required></textarea></td>
                </tr>
                ...
                <tr>
                    ...
                    <a href="admin/dashboard" class="btn btn-large btn-success"><i class="glyphicon glyphicon-backward"></i> &nbsp;Back</a>
                    </td>
                </tr>
               </table>
              </form> 
