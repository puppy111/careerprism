...
?>	
  ...
  <script type="text/javascript">
    ...
    $(document).ready(function() 
	{
	  ...
	  ({ 
       ...
       "serverSide": true, //Feature control DataTables' server-side processing mode.
        ...
        "ajax": {
            "url": "<?php echo site_url('admin/mcategories/ajax_list')?>",
            "type": "POST"
        },
    ...
    function add_person()
    {
      ...
      $('.modal-title').text('Add Main Category'); // Set Title to Bootstrap modal title
    }
    ...
    function edit_person(id)
    {
      ...
      $.ajax({
        url : "<?php echo site_url('admin/mcategories/ajax_edit/')?>/" + id,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {
           
            $('[name="id"]').val(data.parent_cat_id);
            $('[name="parent_cat_name"]').val(data.parent_cat_name);
           /* $('[name="lastName"]').val(data.lastName);
            ...
            $('.modal-title').text('Edit Main Categories'); // Set title to Bootstrap modal title
    ...
    function save()
    {
      ...
      if(save_method == 'add') 
      {
          	url = "<?php echo site_url('admin/mcategories/ajax_add')?>";
      }
      else
      {
        	url = "<?php echo site_url('admin/mcategories/ajax_update')?>";
      }
    ...
    function delete_person(id)
    {
      if(confirm('Are you sure delete this data?'))
      {
        // ajax delete data to database
          $.ajax({
            url : "<?php echo site_url('admin/mcategories/ajax_delete')?>/"+id,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
		...
		{  
            ...
            if(check == true){  
                ...
                $.ajax({   
                    ...
                    type: "POST",  
                    url : "<?php echo site_url('admin/mcategories/ajax_multi_delete')?>/",
                    cache:false, 
					dataType: "JSON", 
        ...
        <form action="#" id="form" class="form-horizontal">
          ...
          <div class="form-body">
            <div class="form-group">
              ...
              <div class="col-md-9">
                <input name="parent_cat_name" placeholder="Category Name" class="form-control" type="text">
              </div>
            </div>
