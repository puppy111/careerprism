    ...
    function edit_person(id)
    {
      ...
      $.ajax({
        ...
        success: function(data)
        {
			...
			*/
			$(".select2-search-choice div").text('civil');
			$("select#branch_c").find("option#16").attr("selected", true);
						alert(data.branch.b);			
						/* $("#s2id_autogen1").val(data.branch.a);*/			 
						$("#s2id_autogen2").val(data.branch.b);			
						/*$("#s2id_autogen3").val(data.branch.c);*/			 
						$("#s2id_autogen4").val(data.branch.d); 
						$("#s2id_autogen4").val(["5", "16"]);			
						/*$('#branch_a').select2();*/
						var values="5,16";$.each(values.split(","), function(i,e)
						{    
						$("select#branch_a option[value='" + e + "']").prop("selected", true);
						});			
        },
