          ...
          <div class="form-body">
           ...
           <div class="form-group">
            <label class="control-label col-md-3">Branch A</label>
              <div class="col-md-9">
              <select id="branch_a" class="form-control chosen-select" multiple name="branch_a[]">
				<?php
           ...
           <div class="form-group">
              ...
              <div class="col-md-9">
               <select id="branch_b" class="form-control chosen-select" multiple name="branch_b[]">
				<?php
				$count2 = sizeof($branch);
                for($i=0;$i<$count2;$i++) 
                {
           ...
           <label class="control-label col-md-3">Branch C</label>
              <div class="col-md-9">
                <select id="" class="form-control chosen-select" multiple name="branch_c[]" id="branch_c">
				<?php
				$count2 = sizeof($branch);
                for($i=0;$i<$count2;$i++) 
                {
           ...
           <div class="form-group">
            <label class="control-label col-md-3">Branch D</label>
              <div class="col-md-9">
                <select id="" class="form-control chosen-select" multiple name="branch_d[]" id="branch_d">
				<?php
				$count2 = sizeof($branch);
                for($i=0;$i<$count2;$i++) 
                {
           ...
           <div class="form-group">
            <label class="control-label col-md-3">Branch E</label>
              <div class="col-md-9">
                <select id="" class="form-control chosen-select" multiple name="branch_e[]" id="branch_e">
				<?php 
				$count2 = sizeof($branch);
                for($i=0;$i<$count2;$i++) 
                {
...
<link rel="stylesheet" type="text/css" href="<?php echo base_url();?>assets/select222.css" />
