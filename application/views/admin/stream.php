...
?>	
		...
		<div class="row">
			<div class="col-md-12">
				<div class="panel panel-default">
					<div class="panel-heading">Stream List</div>
  ...
  <script type="text/javascript">
    ...
    $(document).ready(function() 
	{
	  ...
	  ({ 
       ...
       "serverSide": true, //Feature control DataTables' server-side processing mode.
        ...
        "ajax": {
            "url": "<?php echo site_url('admin/stream/ajax_list')?>",
            "type": "POST"
        },
    ...
    function add_person()
    {
      ...
      $('.modal-title').text('Add Stream'); // Set Title to Bootstrap modal title
    }
    ...
    function edit_person(id)
    {
      ...
      $.ajax({
        url : "<?php echo site_url('admin/stream/ajax_edit/')?>/"+id,
        type: "GET",
        dataType: "JSON",
    ...
    function save()
    {
      ...
      if(save_method == 'add') 
      {
          	url = "<?php echo site_url('admin/stream/ajax_add')?>";
      }
      else
      {
        	url = "<?php echo site_url('admin/stream/ajax_update')?>";
      }
    ...
    function delete_person(id)
    {
      if(confirm('Are you sure delete this data?'))
      {
        // ajax delete data to database
          $.ajax({
            url : "<?php echo site_url('admin/stream/ajax_delete')?>/"+id,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
		...
		{  
            ...
            if(check == true){  
                ...
                $.ajax({   
                    ...
                    type: "POST",  
                    url : "<?php echo site_url('admin/stream/ajax_multi_delete')?>/",
                    cache:false, 
					dataType: "JSON", 
        ...
        <form action="#" id="form" class="form-horizontal">
          ...
          <div class="form-body">
            <div class="form-group">
              ...
              <div class="col-md-9">
                <input name="title" placeholder="Stream" class="form-control" type="text">
              </div>
            </div>
