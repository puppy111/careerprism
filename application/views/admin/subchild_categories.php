...
?>	
    ...
    <div class="row">
        <ol class="breadcrumb">
            ...
            <li class="active">
			<?php
			if(isset($bread_crum['0']['parent_cat_name']))
			{
            	echo strtoupper($bread_crum['0']['parent_cat_name']);
			}
			?>
			
            <li class="active">
			<?php
			if(isset($bread_crum['0']['child_cat_name']))
			{
            	echo strtoupper($bread_crum['0']['child_cat_name']);
			}
			?>            
            </li>
  ...
  <script type="text/javascript">
    ...
    $(document).ready(function() {
      table = $('#table').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('admin/subchildcategories/ajax_list/'.$parent_id.'/'.$child_id)?>",
            "type": "POST"
        },
    ...
    function add_person()
    {
      ...
      $('.modal-title').text('Add Under'); // Set Title to Bootstrap modal title
    }
    ...
    function edit_person(id)
    {
      ...
      $.ajax({
        url : "<?php echo site_url('admin/subchildcategories/ajax_edit/')?>/" + id,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {
           
            $('[name="id"]').val(data.sub_child_cat_id);
            $('[name="sub_child_cat_name"]').val(data.sub_child_cat_name);
    ...
    function save()
    {
      ...
      if(save_method == 'add') 
      {
          url = "<?php echo site_url('admin/subchildcategories/ajax_add/'.$child_id)?>";
      }
      else
      {
        url = "<?php echo site_url('admin/subchildcategories/ajax_update/'.$child_id)?>";
      }
    ...
    function delete_person(id)
    {
      if(confirm('Are you sure delete this data?'))
      {
        // ajax delete data to database
          $.ajax({
            url : "<?php echo site_url('admin/subchildcategories/ajax_delete')?>/"+id,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
		...
		{  
            ...
            if(check == true){  
                ...
                $.ajax({   
                    ...
                    type: "POST",  
                    url : "<?php echo site_url('admin/subchildcategories/ajax_multi_delete')?>/",
                    cache:false, 
					dataType: "JSON", 
        ...
        <form action="#" id="form" class="form-horizontal">
          ...
          <div class="form-body">
            <div class="form-group">
              ...
              <div class="col-md-9">
                <input name="sub_child_cat_name" placeholder="Category Name" class="form-control" type="text">
              </div>
            </div>
