...
?>	
		...
		<div class="row">
			<div class="col-md-12">
				<div class="panel panel-default">
					<div class="panel-heading">Test Names</div>
  ...
  <script type="text/javascript">
    ...
    $(document).ready(function() 
	{
	  ...
	  ({ 
       ...
       "serverSide": true, //Feature control DataTables' server-side processing mode.
        ...
        "ajax": {
            "url": "<?php echo site_url('admin/test/ajax_list')?>",
            "type": "POST"
        },
    ...
    function edit_person(id)
    {
      ...
      $.ajax({
        url : "<?php echo site_url('admin/test/ajax_edit/')?>/"+id,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {
            ...
            $('[name="id"]').val(data.id);
            $('[name="paper_name"]').val(data.paper_name);
    ...
    function save()
    {
      ...
      if(save_method == 'add') 
      {
          	url = "<?php echo site_url('admin/test/ajax_add')?>";
      }
      else
      {
        	url = "<?php echo site_url('admin/test/ajax_update')?>";
      }
    ...
    function delete_person(id)
    {
      if(confirm('Are you sure delete this data?'))
      {
        // ajax delete data to database
          $.ajax({
            url : "<?php echo site_url('admin/test/ajax_delete')?>/"+id,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
		...
		{  
            ...
            if(check == true){  
                ...
                $.ajax({   
                    ...
                    type: "POST",  
                    url : "<?php echo site_url('admin/test/ajax_multi_delete')?>/",
                    cache:false, 
					dataType: "JSON", 
        ...
        <form action="#" id="form" class="form-horizontal">
          ...
          <div class="form-body">
            <div class="form-group">
              ...
              <div class="col-md-9">
                <input name="paper_name" placeholder="Category Name" class="form-control" type="text">
              </div>
            </div>
