  ...
  <script type="text/javascript">
    ...
    $(document).ready(function() {
      table = $('#table').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('admin/childcategories/ajax_list/'.$mcat_id)?>",
            "type": "POST"
        },
    ...
    function add_person()
    {
      ...
      $('.modal-title').text('Add Under <?php
			if(isset($bread_crum['0']['parent_cat_name']))
			{
            	strtoupper($bread_crum['0']['parent_cat_name']);
			}
    ...
    function edit_person(id)
    {
      ...
      $.ajax({
        url : "<?php echo site_url('admin/childcategories/ajax_edit/')?>/" + id,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {
           
            $('[name="id"]').val(data.child_cat_id);
            $('[name="child_cat_name"]').val(data.child_cat_name);
           /* $('[name="lastName"]').val(data.lastName);
            ...
            $('.modal-title').text('<?=strtoupper($bread_crum['0']['parent_cat_name']);?>'); // Set title to Bootstrap modal title
    ...
    function save()
    {
      ...
      if(save_method == 'add') 
      {
          url = "<?php echo site_url('admin/childcategories/ajax_add/'.$mcat_id)?>";
      }
      else
      {
        url = "<?php echo site_url('admin/childcategories/ajax_update/'.$mcat_id)?>";
      }
    ...
    function delete_person(id)
    {
      if(confirm('Are you sure delete this data?'))
      {
        // ajax delete data to database
          $.ajax({
            url : "<?php echo site_url('admin/childcategories/ajax_delete')?>/"+id,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
		...
		{  
            ...
            if(check == true){  
                ...
                $.ajax({   
                    ...
                    type: "POST",  
                    url : "<?php echo site_url('admin/childcategories/ajax_multi_delete')?>/",
                    cache:false, 
					dataType: "JSON", 
        ...
        <form action="#" id="form" class="form-horizontal">
          ...
          <div class="form-body">
            <div class="form-group">
              ...
              <div class="col-md-9">
                <input name="child_cat_name" placeholder="Category Name" class="form-control" type="text">
              </div>
            </div>
