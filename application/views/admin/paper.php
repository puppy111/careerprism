...
<script type="text/javascript">
    ...
    function edit_person(id)
    {
      ...
      $.ajax({
		...
		{  
			//alert( data.branch[index].branch_id+ ": " + data.branch[index].branch_option); 
			if(data.branch[index].branch_option=="a")
			{  
				var brancha = data.branch[index].branch_id;  
				str_arraya.push(brancha);   
			} 
			else if(data.branch[index].branch_option=="b")
			{  
				var branchb = data.branch[index].branch_id;  
				str_arrayb.push(branchb);   
			}  
			
			else if(data.branch[index].branch_option=="c")
			{  
				var branchc = data.branch[index].branch_id;  
				str_arrayc.push(branchc);   
			}  
			else if(data.branch[index].branch_option=="d")
			{  
				var branchd = data.branch[index].branch_id;  
				str_arrayd.push(branchd);   
			}  
			else if(data.branch[index].branch_option=="e")
			{  
				var branche = data.branch[index].branch_id;  
				str_arraye.push(branche);   
			}
		}
		);
		
		    //alert(JSON.stringify(str_arraya));
		    //console.log(str_arraya);
		
			$("#branch_a").val(str_arraya).trigger("liszt:updated");
			$("#branch_b").val(str_arrayb).trigger("liszt:updated");
			$("#branch_c").val(str_arrayc).trigger("liszt:updated");
			$("#branch_d").val(str_arrayd).trigger("liszt:updated");
			$("#branch_e").val(str_arraye).trigger("liszt:updated");
    ...
    function save()
    {
      ...
      {
        url = "<?php echo site_url('admin/paper/ajax_update/')?>";
      }
