 ...
 */
$config['site_title']                 = "careerprism.in";       // Site Title, example.com
$config['admin_email']                = "satya@chaithanyam.org"; // Admin Email, admin@example.com
...
// PHONE NUMBER LOGIN --- START --//---
$config['identity_alt']               = 'phone';            
// PHONE NUMBER LOGIN --- END --//---
...
$config['lockout_time']               = 500;                 // The number of seconds to lockout an account due to exceeded attempts
...
'smtp_port' => 587 , 
'smtp_timeout' =>'30', 
'smtp_user' => 'support@careerprism.in', 
'smtp_pass' => 'support!@#', 
'charset' => 'utf-8',
'newline' => '\r\n',
'wordwrap' => TRUE
